...
class GibbsSampler_A:
    ...
    def sample(self,flag,z1,z2,g11,g22,g12,g21,lambda_1,lambda_2,lambdap_1,lambdap_2,n_iterations):
        ...
        if flag == 1:
            ...
            z2 = torch.randn(self.batch_size,self.latent_dim2).to(_device)       ## For estimating z' in  q(z'|z,x)
            
        for i in range(n_iterations):
            z1  = self.value_calc(z2,g11.t(),g22.t(),g12.t(),g21.t(),lambda_1,lambda_2) 
            z2  = self.value_calc(z1,g11,g22,g12,g21,lambdap_1,lambdap_2) 
...
class GibbsSampler_Z:
    ...
    def value_calc(self,z,g11,g22,g12,g21,lambda_1,lambda_2):
        ...
        out           = mean1+torch.sqrt(var1.float())*torch.randn_like(var1)
        return out
    def gibbs_sample(self,flag,z1,z2,g11,g22,g12,g21,lambda_1,lambda_2,lambdap_1,lambdap_2,n_iterations):
        ...
        for i in range(n_iterations):
            z1  = self.value_calc(z2,torch.transpose(g11,0,1),torch.transpose(g22,0,1),g12,g21,lambda_1,lambda_2) 
            z2  = self.value_calc(z1,g11,g22,g12,g21,lambdap_1,lambdap_2) 
